              ...
              <div className="space-y-2">
                {node.decisions.map((decision) => (
                  <button
                    ...
                    className="w-full text-left p-3 rounded-lg border border-gray-700 bg-gray-800/50 hover:bg-gray-700/50 hover:border-gray-600 transition-all disabled:opacity-50"
                  >
        ...
        {isGenerating && (
          <div className="absolute inset-0 bg-gray-900/80 flex items-center justify-center">
            <div className="flex flex-col items-center gap-3">
              ...
              <div className="text-white">Generating future paths...</div>
            </div>
          </div>
        )}
      </div>
